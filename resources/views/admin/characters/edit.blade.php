  ...
  <div class="container p-5">
    <form action="{{ route('admin.characters.update', $character) }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control" id="strength" name="strength" value="{{ $character->strength }}" required>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control" id="intelligence" name="intelligence" value="{{ $character->intelligence }}" required>
      </div>
